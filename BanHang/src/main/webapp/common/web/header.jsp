	...
	<div class="header">
        <div class="container">
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItems">
                        ...
                        <li><a href="${pageContext.request.contextPath}/product?cid=0">Tất cả sản phẩm</a></li>
                        ...
                        <c:if test="${sessionScope.account != null}">
								<li class ="nav-item">
									<a class="nav-link" href="${pageContext.request.contextPath}/userinfo?id=<c:out value='${account.id}'/>"><i class="fa fa-user"></i> Welcome, ${account.fullname}</a>
								</li>
								<li class ="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <img src="<c:url value="https://html.design/demo/timups/images/slider-img.png" />" class="girl img-responsive" alt="" />
                </div>
            </div>
        </div>
    </div>
