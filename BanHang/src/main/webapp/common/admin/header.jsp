			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="${pageContext.request.contextPath}/adminCRUD-account"><i class="fa fa-table fa-fw"></i>
								Quản trị tài khoản</a></li>
						<li><a href="${pageContext.request.contextPath}/adminCRUD-product"><i class="fa fa-edit fa-fw"></i>
								Quản trị sản phẩm</a></li>
						<li><a href="${pageContext.request.contextPath}/adminCRUD-cate"><i
								class="fa fa-edit fa-fw"></i> Quản trị danh mục</a></li>
						<li><a href="admin-CRUDnews"><i
								class="fa fa-edit fa-fw"></i> Quản trị tin tức</a></li>
						<li><a href="${pageContext.request.contextPath}/adminCRUD-cartlist"><i
								class="fa fa-edit fa-fw"></i> Quản trị đơn hàng</a></li>
						<li><a href="admin-CRUDNCC"><i
								class="fa fa-edit fa-fw"></i> Quản trị nhà cung cấp</a></li>
						<li><a href="admin-income"><i
								class="fa fa-edit fa-fw"></i>Số lượng
								 xe bán</a></li>
						<li><a href="${pageContext.request.contextPath}/admin-thang"><i
