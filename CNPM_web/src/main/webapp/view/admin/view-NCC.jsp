					...
					<tbody>
						...
						<c:forEach var="row" items="${listallncc}">
							<tr>
								...
								<td><a href="admin-home-supplie-showeditNCC?nccid=<c:out value='${row.nccID}'/>">Sửa</a>
						     &nbsp; <a href="admin-home-supplie-deleteNCC?nccid=<c:out value='${row.nccID}'/>">Xóa</a></td>
							</tr>
						</c:forEach>
						<!-- } -->
					</tbody>
